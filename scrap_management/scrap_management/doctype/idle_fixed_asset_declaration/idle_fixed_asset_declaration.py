...
def update_approval_remarks(docname, remarks, action):
    ...
    if action == "Send":
        ...
        state_to_stage_map = {
            ...
            "Approval Pending from Maintenance Assessment Team - HVAC": "Maintenance Assessment Team - HVAC",
            "Approval Pending from Maintenance Assessment HOD - HVAC": "Maintenance Assessment HOD - HVAC",
            "Approval Pending from Maintenance Assessment Team - Mechnical": "Maintenance Assessment Team - Mechnical",
            "Approval Pending from Maintenance Assessment HOD - Mechnical": "Maintenance Assessment HOD - Mechnical",
            "Approval Pending from Maintenance Assessment Team - BMS": "Maintenance Assessment Team - BMS",
            "Approval Pending from Maintenance Assessment HOD - BMS": "Maintenance Assessment HOD - BMS",
            "Approval Pending from Maintenance Assessment Team - Electrical": "Maintenance Assessment Team - Electrical",
            "Approval Pending from Maintenance Assessment HOD - Electrical": "Maintenance Assessment HOD - Electrical",
            "Approval Pending from Maintenance Assessment Team - Utility": "Maintenance Assessment Team - Utility",
            "Approval Pending from Maintenance Assessment HOD - Utility": "Maintenance Assessment HOD - Utility",
